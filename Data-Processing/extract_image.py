...
INPUT_PATH = '/media/chautruonglong/Data/University/Nam-3/Ky-2/PBL5-ky-thuat-may-tinh/Main-project/Main-Dataset/raw/mem/long/Img-20210506T161545Z-001/Img/'
...
for file in files:
    ...
    if ext == 'jpg':
        ...
        for x, y, w, h in faces:
            ...
            file = INPUT_PATH + 'out' + '/102180171_' + str(num) + '.jpg'
