...
namespace AutoAttendant
{
    public partial class App : Application
    {
        public App()
        {
            ...
            InitializeComponent();
            List<StudentNui> notYetAtdList = new List<StudentNui>();
            List<AttendanceNui> listUnknown = new List<AttendanceNui>();
            //MainPage = new NavigationPage(new UnknownPage(listUnknown,notYetAtdList));
